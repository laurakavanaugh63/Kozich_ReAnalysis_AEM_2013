---
title: Reproducting Kozich et al 2013
author:  Laura Kavanaugh
date: "May 10, 2017"
...
```
This is our effort to reproduce data from Kozac et al from @Schloss et al. [Schloss2012]

```{r scaling up, echo=FALSE, include=TRUE} 
...
**Scaling up.** The advantage of the dual-index approach is that a large
    ...
    mock community. We generated 
`r million_sequence_counts` million pairs of sequence reads from the
    16S rRNA gene with an average coverage of 9,913
`r sequence_counts` pairs of reads per sample
    (95% of the samples had more than 
`r percentile_sequence_counts` pairs of sequences) using a new
